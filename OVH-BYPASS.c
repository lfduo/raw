...
int main(int argc, char *argv[ ])
{
        if(argc < 5){
                ...
                fprintf(stderr, "Africa gimme a spoofed please im down bad i can suck your dick\n");
                exit(-1);
        }

        fprintf(stdout, "Africa gimme a spoofed please im down bad i can suck your dick BUT: Starting sockets...\n");
